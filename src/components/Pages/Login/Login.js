                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handaleEmailPassword} className="card-body">
                            <h2 className='text-center font-bold text-white text-2xl'>Log In Now</h2>
                            ...
                            <div className="form-control">
                                ...
                                <label className="label">
                                    <Link to='/signup' className=" text-cyan-400 label-text-alt link link-hover">Create a New Account</Link>
                                </label>
                            </div>
